...
type Certificate = (typeof portfolioData.certificates)[number] & { pdfPath?: string };
...
function CertificateViewer({ certificate }: { certificate: Certificate }) {
...
export default function CertificateCard({ certificate }: { certificate: Certificate }) {
	...
	const hasVerify = !!("verifyUrl" in certificate && certificate.verifyUrl);
							...
							<>
								...
								<div className="flex items-center justify-between gap-3 px-4 py-3">
									...
									<div className="flex items-center gap-2 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
										...
										{hasVerify && "verifyUrl" in certificate && (
											<a
