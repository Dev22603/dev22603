...
import { Code2, Server, Layout, Wrench, Brain, type LucideIcon } from "lucide-react";
import portfolioData from "@/data/portfolio.json";

type SkillCategory = keyof typeof portfolioData.skills;

const categoryConfig: Record<SkillCategory, { label: string; icon: LucideIcon; color: string; description: string }> = {
	backend: {
		label: "Backend",
		icon: Server,
		color: "#00d4aa",
