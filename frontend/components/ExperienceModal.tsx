					...
					>
						...
						<div className="overflow-y-auto max-h-[78vh] p-6 sm:p-8">
							...
							<div className="flex items-start gap-4 mb-6 pr-10">
								{/* Logo/Icon */}
								<div className="flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center bg-[var(--color-primary-dim)] border border-[var(--color-primary)]/20 rounded-xl overflow-hidden relative">
									{experience.logo ? (
										<Image
											src={experience.logo}
