...
export default function ExperienceCard({ experience, onClick }: { experience: Experience; onClick: () => void }) {
	return (
		<motion.div
			whileHover={{ x: 4 }}
			whileTap={{ scale: 0.99 }}
		...
		>
			...
			<div className="p-5 sm:p-6">
				<div className="flex items-start gap-4">
					{/* Logo/Icon */}
					<div className={cn(
						"flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-xl overflow-hidden relative",
