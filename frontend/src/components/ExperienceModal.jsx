				...
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
					...
					>
						...
						<button
							...
							className="absolute top-3 right-3 p-2 text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-background-tertiary)] rounded-lg transition-all duration-200 z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)]"
						>
							<X className="w-5 h-5" />
						</button>
						...
						<div className="overflow-y-auto max-h-[78vh] p-6 sm:p-8">
							...
							<div className="flex items-start gap-4 mb-6 pr-10">
								{/* Logo/Icon */}
								<div className="flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center bg-[var(--color-primary-dim)] border border-[var(--color-primary)]/20 rounded-xl overflow-hidden">
									{experience.logo ? (
										<img
											src={experience.logo}
								...
								<div className="flex-1 min-w-0">
									<div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
										<div>
											...
											<p className="text-base sm:text-lg text-[var(--color-primary)]">
												{experience.company}
											</p>
										</div>

										{experience.status === "Current" && (
											<span className="self-start px-3 py-1 text-xs font-mono bg-[var(--color-primary-dim)] text-[var(--color-primary)] rounded-full border border-[var(--color-primary)]/30 whitespace-nowrap">
												Current
											</span>
										)}
									</div>
